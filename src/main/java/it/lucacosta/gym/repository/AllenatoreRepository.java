...
public interface AllenatoreRepository extends JpaRepository<Allenatore, Long> {
    ...
    List<Allenatore> findAllByNomeContainsIgnoreCaseAndEliminatoFalse(String name);
    List<Allenatore> findAllByEliminatoFalse();
    Boolean existsByIdAndEliminatoFalse(Long id);
    Optional<Allenatore> findByIdAndEliminatoFalse(Long id);

...
public interface SchedaAllenamentoController {
    ...
    @Operation(summary = "Aggiorna gli esercizi di una scheda allenamento", description = "Aggiunge o rimuove esercizi da una scheda allenamento esistente.")
    @ApiResponses(value = {
    ...
    @PutMapping("/{id}/updateExercises")
    public ResponseEntity<SchedaAllenamentoResponse> updateExercises(
            @Parameter(description = "ID della scheda allenamento da aggiornare", required = true) @PathVariable(value = "id") Long id,
            @Parameter(description = "Lista degli ID degli esercizi da aggiungere", required = false) @RequestParam(value = "eserciziDaAggiungere", required = false) List<Long> eserciziDaAggiungere,
            @Parameter(description = "Lista degli ID degli esercizi da rimuovere", required = false) @RequestParam(value = "eserciziDaRimuovere", required = false) List<Long> eserciziDaRimuovere);
